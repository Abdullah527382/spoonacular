...
// APIClient manages communication with the spoonacular API API v1.1
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IngredientsApi = (*IngredientsApiService)(&c.common)
	c.MealPlanningApi = (*MealPlanningApiService)(&c.common)
